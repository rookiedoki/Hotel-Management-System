...
?>
    <body>
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v10.0" nonce="5aX4UBib"></script>
        <header>
          ...
          <div class = "book">
            <form action="login.php" class = "book-form">
                <div class = "form-item">
        ...
        <div class="container2">
          ...
          <div class="col-sm-12 col-md-4">
            ...
            <div class="Title1">Most Visited Place in Vienna Villa Hotel</div>
                <img src="img/v5.jpg" class="modal-hover-opacity" height="220px" width="320px" style="cursor:pointer"
                onclick="onClick(this)">
                <img src="img/v7.jpeg" class="modal-hover-opacity" height="220px" width="320px" style="cursor:pointer" 
                onclick="onClick(this)">
                <img src="img/gym6.jpg" class="modal-hover-opacity" height="220px" width="320px" style="cursor:pointer" 
                onclick="onClick(this)">
                <img src="img/pool2.jpg" class="modal-hover-opacity" height="220px" width="320px" style="cursor:pointer" 
                onclick="onClick(this)">
