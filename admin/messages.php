...
<head>
    ...
    <title>VIENNA VILLA HOTEL</title>
	<!-- Bootstrap Styles-->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="messages.php"><i class="fa fa-desktop"></i> News Letters & Messages</a>
                    </li>
					<li>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                           NewsLetters & Messages<small> Panel</small>
                        </h1>
                    </div>
                </div> 
                 <!-- /. ROW  -->
