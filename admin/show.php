	...
	?>
		<header>
			...
			<address >
				...
				<p>Camarines Sur,<br>Naga City,<br>Main Road</p>
				<p>viennavillahotel.vacation.com.ph</p>
			</address>
		...
		<article>
			...
			<address >
				...
				<p><br></p>
				<p>Customer Name  : <?php echo $Fname." ".$lname;?><br></p>
			</address>
			<table class="meta">
				<tr>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- viennavilla@gmail.com <br> Web :- www.viennavillahotel.vacation.com.ph <br> Phone :- 0938-153-6431 </p>
			</div>
		</aside>
	</body>
</html>
